...
def dumps(obj):
    json = json_serialize.dumps(obj)
    res = _json_to_pickle(json)
    return res
...
def loads(string):
    json = _pickle_to_json(string)
    obj = json_serialize.loads(str(json))
    return obj
